...
// templs_parts_base_tmpl reads file data from disk. It returns an error on failure.
func templs_parts_base_tmpl() (*asset, error) {
	path := "/Users/d/Kairen/personal/projects/go/src/github.com/gophergala/golang-sizeof.tips/templs/parts/base.tmpl"
	name := "templs/parts/base.tmpl"
	bytes, err := bindata_read(path, name)
	if err != nil {
		return nil, err
	}
